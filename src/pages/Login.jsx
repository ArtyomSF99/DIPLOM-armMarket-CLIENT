  ...
  const blurHandler = (e) =>{
    ...
    return(
       ...
       <div className="login_text">
        <h3>Բարի գալուստ ԱրմՄարկետ</h3>
        <p>Մենք առաջարկում ենք ապրանքների լայն տեսականի լավագույն արտադրողներից մատչելի գներով: Մեր ընկերությունն ապահովում է արագ և հուսալի առաքում ամբողջ երկրում, որպեսզի կարողանաք ստանալ ձեր պատվերները ժամանակին և ապահով</p>
       </div>
